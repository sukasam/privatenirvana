...
function format_date_th ($value,$type) { 
	...
	if ($s_day == "0") return "";
	$s_year += 543;
	$month_full_th = array ('','���Ҥ�', '����Ҿѹ��', '�չҤ�', '����¹', '����Ҥ�', '�Զع�¹', '�á�Ҥ�', '�ԧ�Ҥ�',' �ѹ��¹', '���Ҥ�', '��Ȩԡ�¹','�ѹ�Ҥ�');
	$month_brief_th = array ('','�.�.','�.�.','��.�.','��.�.','�.�.','��.�.','�.�.','�.�.','�.�.','�.�.','�.�.','�.�.');
	$day_of_week = array("�ҷԵ��","�ѹ���","�ѧ���","�ظ","����ʺ��","�ء��","�����"); 
	switch ($type) { 
		case "1" : // ?????? 4 ????????? 2548
			$msg = "�ѹ��� ". $s_day . " " .  $month_full_th[$s_month]  . " " .  $s_year ;
			break;
		case "2" :  // 4 ?.?. 2548
...
function format_date_th2($value){
	$date = explode("-",$value);
	$month_full_th = array ('','���Ҥ�', '����Ҿѹ��', '�չҤ�', '����¹', '����Ҥ�', '�Զع�¹', '�á�Ҥ�', '�ԧ�Ҥ�',' �ѹ��¹', '���Ҥ�', '��ɨԡ�¹','�ѹ�Ҥ�');
