...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  ...
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
    ...
    <TABLE>
      ...
      <THEAD>
        ...
        <TR>
          ...
          <TH width="0%" <?php  Show_Sort_bg ("menucate_id", $orderby) ?>> <?php 
	...
	?>
            ...
            <?php   Show_Sort_new ("menucate_id", "No.", $orderby, $sortby,$page,$param2);?>

            &nbsp;</TH>

          <TH width="40%" <?php  Show_Sort_bg ("Menu Name", $orderby) ?>>

           <?php   Show_Sort_new ("menucate_name", "Menu Name", $orderby, $sortby,$page,$param2);?>

            &nbsp;</TH>

           

          <TH width="40%" <?php  Show_Sort_bg ("url_link", $orderby) ?>>

            <?php   Show_Sort_new ("url_link", "URL link", $orderby, $sortby,$page,$param2);?>

            &nbsp;</TH>

          <TH width="0%" nowrap><a>Rank</a></TH>

          <TH width="0%" nowrap><div align="center"><a>Add Submenu</a></div></TH>
