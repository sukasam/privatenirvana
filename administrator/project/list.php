<?php 
	...
	if($_REQUEST['action'] == "delete"){
			...
			//$flgDelete_thumbs = unlink("../../upload/project/".$albums_name."/thumbs/".$file_name);
			$flgDelete_images = unlink("../../upload/project/".$albums_name."/".$file_name);
...
<UL class=shortcut-buttons-set> 
  ...
  <LI><A class=shortcut-button href="../project/?<?php  if($param <> "") echo $param;?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
    <br>
    Back</SPAN></A></LI>
  <?php  }?> 
</UL>
...
<div>
 ...
 <form name="form1" method="get" action="../project/list.php">
  <input name="keyword" type="text" id="keyword" value="<?php  echo $_GET['keyword'];?>">
    ...
    <?php 
			...
			$param2 = get_param($a_param,$a_not_exists);*/
			  ?>
    <a href="../project/list.php?mode=add&project_id=<?php  echo $_GET['project_id'];?>&page=1">Show All</a>
    <?php  
			/*$a_not_exists = array();
  ...
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
	...
	?>
      ...
      <TBODY>
        ...
        <img src="../../upload/project/<?php  echo $_GET['project_id'];?>/<?php  echo $rec["title_name"];?>" width="200">
		  </TD>
