<?php 
	...
	$check_module = "News";
	$page_name = "News Gallery ".get_project_name($conn,$_GET['project_id'])." All";
	$tbl_name = "s_project_group_gallery";
	$fieldlist = array('project_id','title_name','sorts','flag_show') ;
	...
	if($_REQUEST['action'] == "delete"){
			...
			$albums_name = get_project_name($conn,$rec['project_id']);
			//$flgDelete_thumbs = unlink("../../upload/project_group/".$albums_name."/thumbs/".$file_name);
			$flgDelete_images = unlink("../../upload/project_group/".$albums_name."/".$file_name);
...
<UL class=shortcut-buttons-set> 
	...
	?>
    <LI><A class=shortcut-button href="video.php?mode=add&project_id=<?php  echo $_GET["project_id"]; if($param <> "") {?>&<?php  echo $param; }?>"><SPAN><IMG  alt=icon src="../images/pencil_48.png"><BR>Add Images</SPAN></A></LI>
  <LI><A class=shortcut-button href="../project_group/?<?php  if($param <> "") echo $param;?>"><SPAN><IMG  alt=icon src="../images/btn_back.gif"><BR>
    <br>
    Back</SPAN></A></LI>
  <?php  }?> 
</UL>
...
<div>
 ...
 <form name="form1" method="get" action="../project_group/list.php">
  <input name="keyword" type="text" id="keyword" value="<?php  echo $_GET['keyword'];?>">
    ...
    <input name="project_id" type="hidden" id="project_id" value="<?php  echo $_GET['project_id'];?>">
    ...
    <?php 
			...
			$param2 = get_param($a_param,$a_not_exists);*/
			  ?>
    <a href="../project_group/list.php?mode=add&project_id=<?php  echo $_GET['project_id'];?>&page=1">Show All</a>
    <?php  
			/*$a_not_exists = array();
	...
	?>
      ...
      <TBODY>
        <?php  
				    ...
				    $sql = " select *,$tbl_name.create_date as c_date from $tbl_name  where project_id='".$_GET['project_id']."' ";
        ...
        <img src="../../upload/project_group/<?php  echo $_GET['project_id'];?>/<?php  echo $rec["title_name"];?>" width="200">
		  </TD>
