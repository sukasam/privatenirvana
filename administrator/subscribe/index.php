...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
	...
	?>
            ...
            &nbsp;</TH>
          <TH width="100%" <?php  Show_Sort_bg ("email", $orderby) ?>>
           <?php   Show_Sort_new ("email", "Email", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
  ...
  &nbsp;</TH>
      ...
      <TBODY>
        ...
        <TR>
          ...
          <TD><span class="text"><?php  echo $rec["email"] ; ?></span></TD>
          <TD nowrap><span class="text"><?php  echo $rec["date"].' '.$rec["time"]; ?></span></TD>
          <!-- <TD>
