...
<DIV id=tab1 class="tab-content default-tab"><!-- This is the target div. id must match the href of this div's tab -->
  <form name="form2" method="post" action="confirm.php" onSubmit="return check_select(this)">
	...
	?>
            ...
            &nbsp;</TH>
          <TH width="40%" <?php  Show_Sort_bg ("name", $orderby) ?>> <?php   Show_Sort_new ("name", "Name", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="30%" <?php  Show_Sort_bg ("username", $orderby) ?>> <?php   Show_Sort_new ("username", "Username", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="30%" <?php  Show_Sort_bg ("password", $orderby) ?>> <?php   Show_Sort_new ("password", "Password", $orderby, $sortby,$page,$param2);?>
            &nbsp;</TH>
          <TH width="0%"><div align="center"><a>Group</a></div></TH>
          <TH width="0%" nowrap><div align="center"><a>Permisstion</a></div></TH>
