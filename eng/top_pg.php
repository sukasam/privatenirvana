...
if(isset($_GET['subscribeemail']) && $_GET['subscribeemail'] != ""){
    ...
    echo "<script>alert('".EN_THANKS_SUBSCIBE."');window.location='".curPageURLWithoutParam()."'</script>;";
    
    mysqli_close($conn);
}
if(isset($_GET['changelang']) && $_GET['changelang'] != ""){
    $urlReplace = str_replace("/eng","/tha",curPageURLWithoutParam());
    ...
    <div class="pn-head-sect clearfix">
        ...
        <div class="pn-menu-sect clearfix">
            <div class="pn-lang clearfix">
                <a href="?changelang=tha"><img class="pn-lang1 image" src="img/th_flag.png" /></a>
            </div>
