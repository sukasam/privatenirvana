...
==========================================================================================================
 ...
 $mail->senderName = "Dumrus Sukasam"; // ชื่อผู้ส่ง
 $mail->senderMail = "mkung@designm.co.th"; // อีเมลล์ผู้ส่ง
 //$mail->bcc = "bcc@email"; // ส่งแบบ bind carbon copy
 $mail->subject = "Test Email Spec from Customer"; // หัวข้ออีเมลล์
 $mail->body = "Test Email Spec from Customer";   // ข้อความ หรือ HTML ก็ได้
 $mail->attachment[] = "../../upload/dsm_datasharing/sc/".$filename; // ระบุตำแหน่งไฟล์ที่จะแนบ
 $mail->create();
 $mail->send("dumrus@localhost"); // เมลล์ผู้รับ*/
