    ...
    <?php include("top_pg.php"); ?>
        ...
        <div class="port-banner-sect clearfix">
            <div class="port-baner-title clearfix">
                ...
                Private Nirvana Residence North &#x27;n East<br />
                </p>
        ...
        <div class="port-concept-sect clearfix">
            <div class="port-concept-info clearfix">
                <div class="port-concept-pic clearfix">
                    <img class="port-concept-img image" src="img/project_concept.jpg" />
                </div>
                <div class="port-concept-cont clearfix">
                    <p class="port-concept-title">
                    Project Concept<br />
                    </p>
                    <p class="port-concept-details">
                    Clean…bright…quiet and private are the fundamental concepts of our project creation which are&nbsp;also the precise descriptions of “Private Nirvana”, under the “Private Nirvana” trademark only. <br /><br />Under this philosophy, in every project we pay great attention to all details starting from the ideal location, great design and satisfactory service to make our idea flourish and become the pride of both dwellers and project creators. With this intention we believe we have created valuable things for society and we are always very happy to see our customers smile.<br />
                    </p>
                </div>
            </div>
        </div>
        <div class="port-info-sect clearfix">
            <div class="port-info-info clearfix">
                <div class="port-info-pic clearfix">
                    <img class="port-info-img image" src="img/port_img_02.jpg" />
                </div>
                <div class="port-info-cont clearfix">
                    ...
                    <div class="port-info-details">

            <div class="port-info-content">
                <div class="port-info-content-l">Project Name :</div>
                <div class="port-info-content-r">Private Nirvana Residence North 'N East</div>
            </div>

            <div class="port-info-content">
                <div class="port-info-content-l">Concept :</div>
                <div class="port-info-content-r">“ Living Along The Trees... ”</div>
            </div>

            <div class="port-info-content">
                <div class="port-info-content-l">Location :</div>
                <div class="port-info-content-r">Soi Yothin Phatthana 11, Intersection 7, Khlong Chan, Bangkapi, Bangkok</div>
            </div>

            <div class="port-info-content">
                <div class="port-info-content-l">Area :</div>
                <div class="port-info-content-r">
                <span class="txt-bold">Private Nirvana Residence North 12-2-69 Rai</span><br>
                    2-story house, no. of unit 54<br>
                    <span class="txt-bold">Private Nirvana Residence East 14-0-11 Rai</span><br>
                    3-story house, no. of unit 57
                </div>
            </div>

            <div class="port-info-content">
                <div class="port-info-content-l">Facilities :</div>
                <div class="port-info-content-r">・ Public park<br>
                ・ Sport club</div>
            </div>

            <div class="port-info-content">
                <div class="port-info-content-l">Project Opening :</div>
                <div class="port-info-content-r">26 April 2014</div>
            </div>

            <div class="port-info-content">
                <div class="port-info-content-l">Project Closed :</div>
                <div class="port-info-content-r">-</div>
            </div>
        ...
        <div class="port-gallery-sect clearfix">
            ...
            <div class="port-gallery-sect1 clearfix">
                ...
                <div class="port-gallery-img1 clearfix">
                    <img class="port-gallery-pic1 image" src="img/gal01.jpg" />
                </div>

                <div class="port-gallery-sect1-2 clearfix">
                    <div class="port-gallery-img2 clearfix">
                        <img class="port-gallery-pic2 image" src="img/gal02.jpg" />
                    </div>
                    <div class="port-gallery-img3 clearfix">
                        <img class="port-gallery-pic3 image" src="img/gal03.jpg" />
                    </div>
                </div>
            </div>
            ...
            <div class="port-gallery-sect2 clearfix">
                <div class="port-gallery-sect2-1 clearfix">
                    <div class="port-gallery-img4 clearfix">
                        <img class="port-gallery-pic4 image" src="img/gal05.jpg" />
                    </div>
                    <div class="port-gallery-img5 clearfix">
                        <img class="port-gallery-pic5 image" src="img/gal06.jpg" />
                    </div>
                </div>

                <div class="port-gallery-img6 clearfix">
                    <img class="port-gallery-pic6 image" src="img/gal04.jpg" />
                </div>
            </div>

            <div class="port-gallery-sect3 clearfix">
                <div class="port-gallery-img7 clearfix">
                    <img class="port-gallery-pic7 image" src="img/gal07.jpg" />
                </div>
                <div class="port-gallery-img8 clearfix">
                    <img class="port-gallery-pic8 image" src="img/gal08.jpg" />
                </div>
            </div>
    ...
    <img class="port-gallery-pic8 image" src="img/gal08.jpg" />
        ...
        <div class="port-locate-sect clearfix">
            ...
            <div class="port-locate-fac-content clearfix">
                ...
                •&nbsp;Nam Daeng Road - Bang Phli&#x3a; 0 m.<br />•&nbsp;Kanchanaphisek Ring&#x3a; 3 km.<br />•&nbsp;Sky Train Sri Dan Station&#x3a; 5 km.<br />•&nbsp;Jas urban Srinakarin&#x3a; 5 km.<br />
                </p>
                <p class="port-locate-fac-r">
                •&nbsp;Mega Bangna&#x3a; 5.5 km.<br />•&nbsp;Ikea Bangna&#x3a; 5.5 km.<br />•&nbsp;Singapore International School, Bangkok&#x3a; 300m.<br />•&nbsp;Sarasas Witet Suvanabhumi School&#x3a; 2.5 km.<br />
                </p>
            </div>
        </div>
